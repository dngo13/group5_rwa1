...
namespace motioncontrol {
    ...
    {   
        for(int i = 0 ; i<3; i++){
            ...
            arm_ee_link_pose.position.z = bin.position.z + 0.09;
            arm_group_.setMaxVelocityScalingFactor(1.0);
            arm_group_.setPoseTarget(arm_ee_link_pose);
            arm_group_.move();
...
namespace gantry_motioncontrol {
    ...
    /////////////////////////////////////////////////////
    bool Gantry::placePart(geometry_msgs::Pose part_init_pose, geometry_msgs::Pose part_pose_in_frame, std::string location)
    {
